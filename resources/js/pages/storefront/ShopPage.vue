<template>
  <div class="page-container py-10 md:py-16">
    ...
    <PageHeader
      ...
      title="Explore Our Bakery Collection"
    ...
    <div class="bg-white rounded-2xl p-4 md:p-6 border border-[#C08E5D]/20 mb-8 space-y-4 shadow-sm">
      <div class="flex flex-col md:flex-row gap-4 justify-between items-center">
        ...
        <div class="w-full md:w-80">
          <BaseInput
            v-model="searchQuery"
            placeholder="Search banana bread, cookies, cakes..."
            @input="debounceSearch"
          >
            <template #icon-left>
              <svg class="w-4 h-4 text-[#8C7A68]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" /></svg>
            </template>
          </BaseInput>
        </div>
