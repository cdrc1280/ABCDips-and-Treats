    ...
    <div class="page-container py-10 md:py-16">
        ...
        <div v-else class="space-y-16">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 items-start">
                ...
                <div class="space-y-4">
                    <div
                        class="aspect-square rounded-3xl overflow-hidden bg-white border border-[#C08E5D]/20 shadow-md relative">
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <div class="flex items-baseline gap-3 mb-4">
                            ...
                            <BaseBadge v-if="product.is_on_sale" variant="error">Save ₱{{ (product.price -
                                product.sale_price).toFixed(2) }}</BaseBadge>
                        </div>
                    ...
                    <div class="grid grid-cols-2 gap-4 py-4 border-y border-[#C08E5D]/20">
                        <div class="flex items-center gap-3">
                            <div
                                class="w-10 h-10 rounded-xl bg-[#D9A876]/20 flex items-center justify-center text-[#5C3A22]">
                            ...
                            <div>
                                ...
                                <div class="text-sm font-bold text-[#1C1410]">{{ product.prep_time_minutes }} minutes
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <div class="text-sm font-bold"
                                    :class="product.is_in_stock ? 'text-[#6B8F5E]' : 'text-[#B84C3C]'">
                    ...
                    <div v-if="product.allergens && product.allergens.length > 0" class="space-y-2">
                        <span class="block text-xs font-semibold uppercase tracking-wider text-[#5C3A22]">Allergen
                            Information</span>
                        ...
                        <div class="flex items-center gap-4">
                            <div class="flex items-center border border-[#C08E5D]/30 rounded-xl bg-white p-1">
                                ...
                                <span v-tooltip="`Ordering ${quantity} of this item`"
                                    class="w-10 text-center font-bold text-[#1C1410] cursor-help">{{ quantity }}</span>
                            ...
                            <div class="flex-1">
                                <BaseButton variant="primary" full-width size="lg" :loading="adding"
                                    ...
                                    @click="addToCart">
                                    Add {{ quantity }} to Order • ₱{{ ((product.sale_price || product.price) *
                                    quantity).toFixed(2) }}
                                </BaseButton>
                            </div>
                        </div>
            ...
            <div class="bg-white rounded-3xl p-6 md:p-10 border border-[#C08E5D]/20 shadow-sm space-y-8">
                ...
                <div v-if="activeTab === 'description'"
                    class="prose max-w-none text-[#1C1410]/90 leading-relaxed space-y-4">
                ...
                <div v-else-if="activeTab === 'nutrition' && product.nutrition" class="max-w-md space-y-4">
                    <div class="border border-[#1C1410] p-4 rounded-xl space-y-2 text-[#1C1410]">
                        ...
                        <div
                            class="border-t-8 border-[#1C1410] my-2 pt-2 flex justify-between items-baseline font-extrabold text-lg">
