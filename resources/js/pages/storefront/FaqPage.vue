<template>
  <div class="max-w-3xl mx-auto px-6 py-16">
    ...
    <div class="space-y-3">
      ...
      >
        ...
        >
          ...
          <svg
            class="w-5 h-5 text-[#C08E5D] flex-shrink-0 transition-transform duration-300"
    ...
    <div class="mt-14 bg-[#5C3A22] rounded-3xl p-8 text-center text-[#FBF3E7]">
      ...
      <p class="text-[#FBF3E7]/70 text-sm mb-6">Our team is happy to help. Send us a message and we'll get back to you shortly.</p>
      <RouterLink to="/contact" class="inline-flex items-center gap-2 bg-[#D9A876] text-[#1C1410] px-6 py-3 rounded-xl font-bold text-sm hover:bg-[#C08E5D] transition-colors">Contact Us →</RouterLink>
    </div>
  </div>
</template>
...
const faqs = [
  ...
  { cat: 'Delivery', q: 'Where do you deliver?', a: 'We currently deliver within Metro Manila. Same-day delivery is available for orders placed before 10:00 AM. Orders placed after may be scheduled for next-day delivery.' },
  { cat: 'Delivery', q: 'How much is the delivery fee?', a: 'Delivery fees vary depending on your location within Metro Manila. The exact fee will be shown at checkout before you confirm your order.' },
